...
class UNet(nn.Module):
    def __init__(self, config):
        ...
        ch, out_ch, ch_mult = (
            ...
            2,
            tuple(self.config["feature_multi"]),
        )
        num_res_blocks = self.config["num_resblock"]
        ...
        self.ch = self.config["feature_channels"]
        self.temb_ch = self.ch * 4
        self.num_resolutions = len(ch_mult)
        self.num_res_blocks = num_res_blocks
        self.resolution = self.config["resolution"][0]
        self.in_channels = in_channels
        # downsampling
        self.conv_in = torch.nn.Conv2d(
            in_channels, self.ch, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
        )
        ...
        self.conv_out = torch.nn.Conv2d(
            block_in, out_ch, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)
        )
